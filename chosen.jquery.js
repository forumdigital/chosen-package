...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      for (var i = 0; i < this.form_field_jq[0].length; i++) {
        if (this.form_field_jq[0][i].selected && this.form_field_jq[0][i].value != '?'){
            this.is_first_updated = true;
        }
        else if (this.form_field_jq[0][i].selected && this.form_field_jq[0][i].value == '?'){
            this.is_first = true;
        }
      }
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.is_multiple) {
          ...
          if ((this.current_selectedIndex === 0 && this.is_first) || this.is_first ){
            if (this.current_selectedIndex === 0 && !this.is_first_updated) {
                this.form_field.options[item.options_index].selected = true;
            }
            else{
